...
are $\hat\beta_1 \approx 0.50$ and $\hat\beta_2 \approx 0.40$.

are $\hat\beta_1 \approx 0.50$ and $\hat\beta_2 \approx 0.40$.

are $\hat\beta_1^* \approx 0.50$ and

are $\hat\beta_1^* = \hat\beta_1^* $ and

are $$\hat\beta_1^* = \hat\beta_1^*$$ and are $$\hat\beta_1^* = \hat\beta_1^*$$ and
