...
This reflects the [well-known](https://en.wikipedia.org/wiki/Odds_ratio#Role_in_logistic_regression) relation between multiple regression parameters and the OR
