...
Since the NLP revolution in 2023, we are able to analyze text data at a quality and scale that was unthinkable just a few years ago. I am exploring these new possibilities in several areas. I collaborate on projects in communication science, analyzing media coverage of various topics such as [activist groups](https://osf.io/preprints/psyarxiv/yhn54) and [climate change](https://osf.io/preprints/socarxiv/mv2q6_v1) at scale. I am also involved in projects investigating [how LLMs and embedding models can be used for psychometric scale development](https://osf.io/preprints/psyarxiv/vf3se_v2) and work with the [MITNB consortium](https://mitnb.org/) on the analysis open-text responses from EMA studies using NLP, in addition to several other projects on using LLMs to analyze complex text data.
